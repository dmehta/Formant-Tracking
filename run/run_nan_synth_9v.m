...
runSynth_OLA_wrapper_nan_synth_9v
...
n2 = wavread('n_synth.wav');

%% assumes 50 % overlap of frames and 100 ms frames
nan = zeros(76*500, 1);
nan(1:(19+1)*500) = n;
figure, plot(nan)
...
wavwritedm(nan, fs, 16, 'nan_synth9v.wav')
...
trueState = [trueState1 trueState2b trueState3b trueState4b trueState1];
save('trueState9v', 'trueState')