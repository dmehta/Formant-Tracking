...
%%
source = 2; % 1 - TIMIT wav files; 2 - synthesized wav files
cepOrder = 15;
fs = 2*8000;
...
% tic
QscaleV = .1:100:5e4;
rmseQ = zeros(1, length(QscaleV));
for rr = 1:length(QscaleV)
for ii = 311%:516 % praat bombs on 364
    %%%%%%%%%%%%%%%%%%%%%%%%%% Load Data %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    vtrDbNum = ii;
...
%                 end
    ...
    rmseQ(rr) = rmseAllS(vtrDbNum, 1, numFormants+1);
end % Qscale
end
% toc
