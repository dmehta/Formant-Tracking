...
%% UNCOMMENT IF WANTING PERIODIC SOURCE
% noise_type = '1';
% vowel = 'a';
% f0 = [100 100];
% gender = 'm';
% % fs = 8000;
% dur = 1.5*floor(N/fs*100)/100; % two decimal places...and add a buffer, that's why 1.5
% dcFlow = 0;
% OQ = 60;
% jitter = 0;
% shimmer = 0;
...
for i=1:numFrames
    ...
    %tmp = filter(num, denom, inputSource(wLeft(i):wRight(i))); % periodic input
