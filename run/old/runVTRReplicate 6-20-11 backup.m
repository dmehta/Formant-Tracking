...
source = 2; % 1 - TIMIT wav files; 2 - synthesized wav files, 3 - synthesized with f0
cepOrder = 15;
fs = 2*3500;
...
% output dir
savedir = '..\results\temp';
% savedir = '..\results\EKS_trackBW1_ARMAcep15_ar12ma0_win20_pe07_fs7000_timitVAD_useCorr0_Jacoblin_Q5e4bw1e4_BWfix';
