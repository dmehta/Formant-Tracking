...
%% Set parameters
% vtrDbNum = [1:152 154:192 194:516]; % for praat on VTRsynthf0
...
vtrDbNum = 510:516; % Choose VTR database number(s) to process from 1 to 516
% vtrDbNum = 200;
...
% output dir
savedir = '..\results\replicateJASAVTR';
