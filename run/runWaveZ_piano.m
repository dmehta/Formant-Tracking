...
if algFlag(EKF)
    smooth = 0;
    [x_estEKF x_errVarEKF] = formantTrackEKSZ_piano(y, Fmatrix, Q, R, x0, formantInds, fs, bwStates, nP, smooth);
...
if algFlag(EKS)
    smooth = 1;
    [x_estEKS x_errVarEKS] = formantTrackEKSZ_piano(y, Fmatrix, Q, R, x0, formantInds, fs, bwStates, nP, smooth);    
