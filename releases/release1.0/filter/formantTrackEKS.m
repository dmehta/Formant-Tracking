function [smooth_state, smooth_var] = formantTrackEKS(data, F, Q, R, x0, formantInds, fs, bwStates)
%function [m_up, P_up] = formantTrackEKF2(data, formantInds, pNoiseVar,oNoiseVar,fs,trBW_flag,BW_data,initial_state)
