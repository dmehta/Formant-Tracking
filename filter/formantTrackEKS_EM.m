...
while (i <= maxNumIter)
    ...
    [theta] = EKS_EM(y, m_upS, P_upS, PP_upS, fs, bwStates, formantInds);
...
function [theta] = EKS_EM(y, m_upS, P_upS, PP_upS, fs, bwStates, formantInds)
...
theta.Q = (C - theta.F*B');     % Update estimate of Q
theta.R = RdiagConst;           % Update estimate of R 
