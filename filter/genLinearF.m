...
% Linearization of the formant/bandwidth to LPC cepstrum mapping following
% Deng '07 rather than a more simple and accurate Taylor-series approach.
% See getH_F for the method currently in use.
...
numFRegions = 2000; % Number of regions for formant/cepstrum linearization
