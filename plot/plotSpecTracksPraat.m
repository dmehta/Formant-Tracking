...
function [] = plotSpecTracksPraat(audio, f, bw, aParams, formantTimes, trackBW)
...
xlabel('Time (s)'), ylabel('Frequency (Hz)'), title('Tracks of formants (blue) and anti-formants (green)')
hold on;
